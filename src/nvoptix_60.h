...
} OptixFunctionTable_60;

OptixResult __cdecl optixQueryFunctionTable_60(unsigned int numOptions, int *optionKeys, const void **optionValues, void *functionTable, size_t sizeOfTable);
