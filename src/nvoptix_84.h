...
} OptixFunctionTable_84;

OptixResult __cdecl optixQueryFunctionTable_84(unsigned int numOptions, int *optionKeys, const void **optionValues, void *functionTable, size_t sizeOfTable);
